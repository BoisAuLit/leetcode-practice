...
s = Solution()
input_ = [2, 3, 1, 1, 4]  # Expecting True
# input_ = [3, 2, 1, 0, 4]  # Expecting False

result = s.canJump(input_)
print(result)
...
Note: We can let our gas tank get to zero as long as we are able to gas up
at that immediate location (element in the array) that our car is currently at.
"""
